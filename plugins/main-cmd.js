...
console.log(`TEST-BOT ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+22781289418'; // Replace this with the actual owner number
        const ownerName = 'ᴋᴀᴡᴀᴋɪ227 Official'; // Replace this with the owner's name
        const organization = 'TEST-BOT CODERS'; // Optional: replace with the owner's organization
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_TEST-BOT..._*'  }, { quoted: mek } )
...
try{
let dec = `> TEST-BOT REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ TEST-BOT REPO: ${bot.REPO_LINK} 
┃
